...
class CrossEntropyLossLayer:
    ...
    def backward(self):
        self.dx = self.dx = (self.x - self.label) / self.x / (1 - self.x)/self.x.shape[0]
        return self.dx
...
def main():
    ...
    np.savetxt ("weights1.csv", inner_layers[0].weights, delimiter = ",")
    np.savetxt ("biases1.csv", inner_layers[0].bias, delimiter = ",")
    np.savetxt ("weights2.csv", inner_layers[2].weights, delimiter = ",")
    np.savetxt ("biases2.csv", inner_layers[2].bias, delimiter = ",")
